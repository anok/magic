...
get '/' do
  r = 'BEM VINDO AO MARAVILHOSO MUNDO DE MAGIC! AQUI VOCE TERÁ AMIGOS!'
  ...
  r += 'Also, não tem nenhuma proteção em nenhum lugar para as listas que você cria aqui, afinal, o que você estava esperando do LOST?'
  lists = List.all
  lists.each do |list|
